...
describe('sortItemsByCompleted', () => {
  test('Incomplete items are sorted before completed items', () => {
    const data: ListItem[] = [
      new ListItem('Some item', 'list-id', {
        id: 'aaaaaaaaaaaaaaaa',
        status: 'Completed',
...
describe('sortItemsByOrder', () => {
  test('Items are sorted in ascending order by order value', () => {
    const data = [
      new ListItem('Some item', 'list-id', { id: 'item-2', sectionIndex: 2 }),
      new ListItem('Some item', 'list-id', { id: 'item-1', sectionIndex: 1 })
    ];
    const order = new Map([
      ['item-1', 1],
      ['item-2', 2]
...
describe('sortItems', () => {
  ...
  test('When due dates are active, items without due dates are not reordered relative to each other', () => {
    const data: ListItem[] = [
      new ListItem('First item', 'list-id', {
        id: 'aaaaaaaaaaaaaaaa',
        dateDue: null
      }),
      new ListItem('Second item', 'list-id', {
        id: 'aaaaaaaaaaaaaaaa',
        dateDue: null
      })
    ];
  ...
  test('Identical items are both returned', () => {
    const data: ListItem[] = [
      new ListItem('Some item', 'list-id', { id: 'aaaaaaaaaaaaaaaa' }),
      new ListItem('Some item', 'list-id', { id: 'aaaaaaaaaaaaaaaa' })
    ];
    const expected: ListItem[] = [
      new ListItem('Some item', 'list-id', { id: 'aaaaaaaaaaaaaaaa' }),
